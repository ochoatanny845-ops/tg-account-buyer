...
<emoji id="5377505475015235101"><emoji id="5377505475015235101"><emoji id="5377505475015235101">💰</emoji></emoji></emoji> <b>快速开始：</b>
1. 点击"<emoji id="5377505475015235101"><emoji id="5377505475015235101"><emoji id="5377505475015235101">💰</emoji></emoji></emoji> 查看价格"查看收购价格
2. 点击"<emoji id="5332724926216428039"><emoji id="5332724926216428039"><emoji id="5332724926216428039">📱</emoji></emoji></emoji> 接码登录"或"<emoji id="5449683594425410231"><emoji id="5449683594425410231"><emoji id="5449683594425410231">📤</emoji></emoji></emoji> 上传 Session"提交账号
3. 等待管理员审核（通常 1-24 小时）
4. 审核通过后余额自动到账
5. 达到提现金额即可申请提现

<emoji id="5395444784611480792"><emoji id="5395444784611480792"><emoji id="5395444784611480792">📝</emoji></emoji></emoji> <b>提现说明：</b>
...
async def my_balance(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = f"""
<emoji id="5197434882321567830"><emoji id="5197434882321567830"><emoji id="5197434882321567830">💵</emoji></emoji></emoji> <b>我的余额</b>

当前余额：<b>{user.balance:.2f} USDT</b>
TRC20 地址：<code>{user.trc20_address or '未设置'}</code>

{'<emoji id="5461117441612462242"><emoji id="5461117441612462242"><emoji id="5461117441612462242">✅</emoji></emoji></emoji> 可以提现' if user.balance >= Config.MIN_WITHDRAWAL else f'<emoji id="5210952531676504517"><emoji id="5210952531676504517"><emoji id="5210952531676504517">❌</emoji></emoji></emoji> 余额不足（最低 {Config.MIN_WITHDRAWAL} USDT）'}

💡 使用"<emoji id="5341715473882955310"><emoji id="5341715473882955310"><emoji id="5341715473882955310">⚙️</emoji></emoji></emoji> 设置地址"按钮可以修改 TRC20 地址
"""
...
<emoji id="5461117441612462242"><emoji id="5461117441612462242"><emoji id="5461117441612462242">✅</emoji></emoji></emoji> 解压完成

<emoji id="5231200819986047254"><emoji id="5231200819986047254"><emoji id="5231200819986047254">📊</emoji></emoji></emoji> 统计信息：
• 账号数量：{account_count} 个
• 已配置密码：{matched_passwords} 个

<emoji id="5451882707875276247"><emoji id="5451882707875276247"><emoji id="5451882707875276247">⏳</emoji></emoji></emoji> 正在验证并提交...
""", parse_mode='HTML')
    ...
    # 通知用户
    await update.message.reply_text(f"""
<emoji id="5461117441612462242"><emoji id="5461117441612462242"><emoji id="5461117441612462242">✅</emoji></emoji></emoji> 提交完成

<emoji id="5231200819986047254"><emoji id="5231200819986047254"><emoji id="5231200819986047254">📊</emoji></emoji></emoji> 处理结果：
• 成功：{valid_count} 个
...
<emoji id="5231200819986047254"><emoji id="5231200819986047254"><emoji id="5231200819986047254">📊</emoji></emoji></emoji> 账号数量：{len(sessions)} 个
<emoji id="5377505475015235101"><emoji id="5377505475015235101"><emoji id="5377505475015235101">💰</emoji></emoji></emoji> 总金额：<b>{total_price} USDT</b>
...
• <emoji id="5377505475015235101"><emoji id="5377505475015235101"><emoji id="5377505475015235101">💰</emoji></emoji></emoji> 收购价: <b>{price} USDT</b>
...
async def receive_amount(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # 显示确认信息
    text = f"""
<emoji id="5233326571099534068"><emoji id="5233326571099534068"><emoji id="5233326571099534068">💸</emoji></emoji></emoji> <b>提现确认</b>
...
<emoji id="5447644880824181073"><emoji id="5447644880824181073"><emoji id="5447644880824181073">⚠️</emoji></emoji></emoji> 请仔细核对地址，确认无误后点击下方按钮
"""
