...
<tg-emoji emoji-id="5377505475015235101">💰</tg-emoji> <b>快速开始：</b>
1. 点击"<tg-emoji emoji-id="5377505475015235101">💰</tg-emoji> 查看价格"查看收购价格
2. 点击"<tg-emoji emoji-id="5332724926216428039">📱</tg-emoji> 接码登录"或"<tg-emoji emoji-id="5449683594425410231">📤</tg-emoji> 上传 Session"提交账号
3. 等待管理员审核（通常 1-24 小时）
4. 审核通过后余额自动到账
5. 达到提现金额即可申请提现

<tg-emoji emoji-id="5395444784611480792">📝</tg-emoji> <b>提现说明：</b>
...
async def my_balance(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = f"""
<tg-emoji emoji-id="5197434882321567830">💵</tg-emoji> <b>我的余额</b>

当前余额：<b>{user.balance:.2f} USDT</b>
TRC20 地址：<code>{user.trc20_address or '未设置'}</code>

{'<tg-emoji emoji-id="5461117441612462242">✅</tg-emoji> 可以提现' if user.balance >= Config.MIN_WITHDRAWAL else f'<tg-emoji emoji-id="5210952531676504517">❌</tg-emoji> 余额不足（最低 {Config.MIN_WITHDRAWAL} USDT）'}

💡 使用"<tg-emoji emoji-id="5341715473882955310">⚙️</tg-emoji> 设置地址"按钮可以修改 TRC20 地址
"""
...
<tg-emoji emoji-id="5461117441612462242">✅</tg-emoji> 解压完成

<tg-emoji emoji-id="5231200819986047254">📊</tg-emoji> 统计信息：
• 账号数量：{account_count} 个
• 已配置密码：{matched_passwords} 个

<tg-emoji emoji-id="5451882707875276247">⏳</tg-emoji> 正在验证并提交...
""", parse_mode='HTML')
    ...
    # 通知用户
    await update.message.reply_text(f"""
<tg-emoji emoji-id="5461117441612462242">✅</tg-emoji> 提交完成

<tg-emoji emoji-id="5231200819986047254">📊</tg-emoji> 处理结果：
• 成功：{valid_count} 个
...
<tg-emoji emoji-id="5231200819986047254">📊</tg-emoji> 账号数量：{len(sessions)} 个
<tg-emoji emoji-id="5377505475015235101">💰</tg-emoji> 总金额：<b>{total_price} USDT</b>
...
• <tg-emoji emoji-id="5377505475015235101">💰</tg-emoji> 收购价: <b>{price} USDT</b>
...
async def receive_amount(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # 显示确认信息
    text = f"""
<tg-emoji emoji-id="5233326571099534068">💸</tg-emoji> <b>提现确认</b>
...
<tg-emoji emoji-id="5447644880824181073">⚠️</tg-emoji> 请仔细核对地址，确认无误后点击下方按钮
"""
